    ...
    <Layout>
      ...
      <section className="section-dark py-16 md:py-20 topo-pattern">
        <div className="container-custom">
          <AnimatedSection>
            <h1 className="font-heading text-3xl font-medium text-white md:text-4xl">Política de Privacidade</h1>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="mx-auto max-w-3xl">
            <AnimatedSection>
              <h2 className="font-heading text-xl font-medium mb-4 text-foreground">1. Informações Coletadas</h2>
              ...
              <h2 className="font-heading text-xl font-medium mb-4 mt-8 text-foreground">2. Uso das Informações</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-xl font-medium mb-4 mt-8 text-foreground">3. Compartilhamento de Dados</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-xl font-medium mb-4 mt-8 text-foreground">4. Cookies e Tecnologias</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-xl font-medium mb-4 mt-8 text-foreground">5. Seus Direitos</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-xl font-medium mb-4 mt-8 text-foreground">6. Contato</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
