...
const PoliticaPrivacidade = () => {
  return (
    <Layout>
      ...
      <section className="hero-dark py-16 md:py-20 topo-pattern">
        <div className="container-custom">
          <AnimatedSection>
            <h1 className="text-3xl font-extrabold text-white md:text-4xl">Política de Privacidade</h1>
            <p className="mt-3 text-muted-foreground">Última atualização: Janeiro de 2026</p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="mx-auto max-w-3xl prose prose-invert prose-sm">
            <AnimatedSection>
              <h2 className="text-xl font-bold mb-4">1. Informações Coletadas</h2>
              ...
              <h2 className="text-xl font-bold mb-4 mt-8">2. Uso das Informações</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="text-xl font-bold mb-4 mt-8">3. Compartilhamento de Dados</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="text-xl font-bold mb-4 mt-8">4. Cookies e Tecnologias</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="text-xl font-bold mb-4 mt-8">5. Seus Direitos</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="text-xl font-bold mb-4 mt-8">6. Contato</h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
